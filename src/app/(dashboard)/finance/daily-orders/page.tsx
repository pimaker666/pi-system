...
export default async function DailyOrdersPage({ searchParams }: {
  ...
  return <div className="space-y-6">
    ...
    <form className="grid gap-3 rounded-md border p-4 md:grid-cols-4 xl:grid-cols-8">
      ...
      <select name="category" defaultValue={filters.category ?? ''} className="h-10 rounded-md border bg-background px-3 text-sm"><option value="">全部发货分类</option><option value="stock">现货</option><option value="sample">样品</option><option value="custom">定制</option></select>
